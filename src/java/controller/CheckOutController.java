...
public class CheckOutController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int shippingId = new ShippingDBcontext().createReturnId(shipping); // Return the auto-incremented ID of the saved record
        ...
        // Redirect to the success notification page
