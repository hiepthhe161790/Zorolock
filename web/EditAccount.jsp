                        ...
                        <form action="EditAccount" method="post">
                            <div class="modal-header">						
                                <h4 class="modal-title">Edit Account</h4>
                                  <button type="button" style="margin-left: 525px" class="btn btn-primary" onclick="back()">x</button>
                            </div>
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="active" class="form-control" required>
                                        <option value="true" ${account.active == 'true' ? 'selected' : ''}>True</option>
                                        <option value="false" ${account.active == 'false' ? 'selected' : ''}>False</option>
                                    </select>
                                </div>
